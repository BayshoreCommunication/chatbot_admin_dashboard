...
import AdminAPIDefault, { LeadItem } from '@/services/api'
...
export default function Dashboard() {
  ...
  const [organizationUsage, setOrganizationUsage] =
    useState<OrganizationUsageAdmin | null>(null)
  ...
  const handleOrganizationClick = async (organization: Organization) => {
    ...
    try {
      ...
      console.error(
        `Error fetching usage for organization ${organization.id}:`,
        error
      )
    } finally {
  ...
  return (
    <Layout>
      ...
      <Layout.Body className='mx-auto max-w-[2000px]'>
        <div className='mb-2 flex items-center justify-between space-y-2'>
          <div className=''>
            <h2 className='text-2xl font-bold tracking-tight'>Dashboard</h2>
            <p className='text-muted-foreground'>
              Welcome to your AI Platform Analytics Hub - Monitor usage,
              conversations, and business insights in real-time.
            </p>
          </div>
          <div className='flex items-center space-x-2'>
            ...
            <Button
              ...
              disabled={
                !['organizations', 'conversations', 'subscriptions'].includes(
                  activeTab
                )
              }
            >
        ...
        >
          ...
          <TabsContent value='overview' className='space-y-4'>
            {showOrgStats ? (
              ...
              <ConversationStatsPage
                onBack={() => setShowConversationStats(false)}
              />
            ) : (
              <OverviewTab
          ...
          <TabsContent value='leads' className='space-y-4'>
            <LeadsTab leads={leads} loading={loading.leads} />
          </TabsContent>
        </Tabs>
      </Layout.Body>
    </Layout>
